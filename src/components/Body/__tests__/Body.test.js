...
const TILE_VALUE_MEAN_ID = 'tile-value-Mean';
const TILE_VALUE_MEDIAN_ID = 'tile-value-Median';
const TILE_VALUE_STDDEV_ID = 'tile-value-Std Deviation';
const TILE_VALUE_MODE_ID = 'tile-value-Mode';
